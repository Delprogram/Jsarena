...
export default class Player {
    ...
    animate() {
        ...
        if (
            ...
            // On vérifie si on a attendu assez longtemps (5 frames)
            if (this.attackFrameCounter >= this.attackFramesPerSprite) {
                this.attackFrameCounter = 0; // On reset le compteur de temps
                this.attackSpriteIndex++; // On passe à l'image suivante
            }
